...
public class UserDO {
     ...
     *
     * @mbg.generated Thu Jan 17 15:55:12 CST 2019
     */
    private Integer id;
	...
	public String toString() {
		return "UserDO [id=" + id + ", name=" + name + ", gender=" + gender + ", age=" + age + ", telphone=" + telphone
				+ ", registerMode=" + registerMode + ", thirdPartyId=" + thirdPartyId + "]";
	}
